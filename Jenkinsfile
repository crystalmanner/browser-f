...
properties([
    ...
    parameters([
        ...
        string(defaultValue: 's3://cdncliqz/update/ghostery-desktop_beta/latest.xpi',
        ...
        string(defaultValue: "0.1.0", name: "CQZ_VERSION"),
...
node('docker && us-east-1') {
    stage("Copy XPI") {
        UPLOAD_PATH="s3://repository.cliqz.com/dist/$CQZ_RELEASE_CHANNEL/${params.CQZ_VERSION}/${CQZ_BUILD_ID}/ghostery@cliqz.com.xpi"
