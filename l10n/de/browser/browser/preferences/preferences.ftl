...
history-dontremember-description = { -brand-short-name } wird dieselben Einstellungen wie im Ghost Modus verwenden und keinerlei Chronik anlegen, während du &brandShortName; benutzen.
history-private-browsing-permanent =
    .label = Immer den Ghost Modus verwenden
    .accesskey = V
